<div>
    <flux:heading size="xl">WCAG Knowledge Base</flux:heading>
    <flux:subheading>Browse success criteria and manage global examples with code snippets and references.</flux:subheading>

    <flux:separator variant="subtle" class="my-6" />

    <div class="mb-6 max-w-sm">
        <flux:input wire:model.live.debounce.300ms="search" placeholder="Search by number or name…" icon="magnifying-glass" />
    </div>
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            @empty
                <flux:callout icon="magnifying-glass" color="zinc">
                    <flux:callout.text>No criteria match your search.</flux:callout.text>
                </flux:callout>
            @endforelse
        </div>
        ...
        <div class="lg:col-span-3">
                ...
                <flux:card class="space-y-0 !p-0 overflow-hidden">
                    ...
                    <div class="px-6 py-5 space-y-4">
                        <div class="flex items-center gap-2">
                            <flux:heading size="sm">Examples</flux:heading>
                        ...
                        @empty
                            <flux:callout icon="light-bulb" color="zinc">
                                <flux:callout.text>No examples yet. Add the first one below.</flux:callout.text>
                            </flux:callout>
                        @endforelse
                    </div>
                    ...
                    <div class="px-6 py-5">
                        ...
                        <form wire:submit="saveExample" class="space-y-4">
                            <flux:field>
                                ...
                                <flux:input wire:model="exampleTitle" placeholder="e.g. Button with visible label" />
                                <flux:error name="exampleTitle" />
                            </flux:field>

                            <flux:field>
                                <flux:label>Description</flux:label>
                                <flux:textarea wire:model="exampleDescription" rows="3" placeholder="Explain the example…" />
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div class="sm:col-span-2">
                                    <flux:field>
                                        <flux:label>Code Snippet</flux:label>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <flux:field>
                                    <flux:label>Reference URL</flux:label>
                                    <flux:input wire:model="exampleUrl" type="url" placeholder="https://…" />
                                    <flux:error name="exampleUrl" />
                                </flux:field>
                                <flux:field>
                                    <flux:label>Link Label</flux:label>
                                    <flux:input wire:model="exampleUrlLabel" placeholder="MDN – button element" />
                                </flux:field>
                            </div>
            ...
            @else
                <flux:callout icon="book-open" color="zinc">
                    <flux:callout.heading>Select a criterion</flux:callout.heading>
                    <flux:callout.text>Choose a success criterion from the list to view details and manage examples.</flux:callout.text>
                </flux:callout>
            @endif
        </div>
    </div>
