...
<div <?php echo e($attributes->class(['flex items-center gap-2 p-2 text-xs [:where(&)]:text-zinc-500 dark:[:where(&)]:text-zinc-300'])); ?>>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($field): ?>
        ...
        <div><?php echo e($prefix ?? ''); ?><slot field="<?php echo e($field); ?>" <?php if($format): ?> format="<?php echo e($format); ?>" <?php endif; ?>></slot><?php echo e($suffix ?? ''); ?></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH /var/www/html/local_packages/flux-pro-main/stubs/resources/views/flux/chart/tooltip/value.blade.php ENDPATH**/ ?>