...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['as' => 'div','class' => 'cursor-pointer [ui-time-picker[data-empty]_&]:hidden [ui-time-picker:has([disabled])_&]:hidden','variant' => 'subtle','size' => $size === 'sm' || $size === 'xs' ? 'xs' : 'sm','square' => true,'tabindex' => '-1','ariaLabel' => 'Clear time','xOn:click.prevent.stop' => '$el.closest(\'ui-time-picker\').clear();','inset' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['as' => 'div','class' => 'cursor-pointer [ui-time-picker[data-empty]_&]:hidden [ui-time-picker:has([disabled])_&]:hidden','variant' => 'subtle','size' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($size === 'sm' || $size === 'xs' ? 'xs' : 'sm'),'square' => true,'tabindex' => '-1','aria-label' => 'Clear time','x-on:click.prevent.stop' => '$el.closest(\'ui-time-picker\').clear();','inset' => true]); ?>
...
<?php /**PATH /var/www/html/local_packages/flux-pro-main/stubs/resources/views/flux/time-picker/input.blade.php ENDPATH**/ ?>