...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['as' => 'div','class' => 'cursor-pointer ms-2 '.e($size === 'sm' || $size === 'xs' ? '-me-1' : '-me-2').' [[data-flux-date-picker-button]:has([data-flux-date-picker-placeholder])_&]:hidden [[data-flux-date-picker][disabled]_&]:hidden','variant' => 'subtle','size' => $size === 'sm' || $size === 'xs' ? 'xs' : 'sm','square' => true,'tabindex' => '-1','ariaLabel' => 'Clear date','xOn:click.prevent.stop' => '$el.closest(\'ui-date-picker\').clear()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['as' => 'div','class' => 'cursor-pointer ms-2 '.e($size === 'sm' || $size === 'xs' ? '-me-1' : '-me-2').' [[data-flux-date-picker-button]:has([data-flux-date-picker-placeholder])_&]:hidden [[data-flux-date-picker][disabled]_&]:hidden','variant' => 'subtle','size' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($size === 'sm' || $size === 'xs' ? 'xs' : 'sm'),'square' => true,'tabindex' => '-1','aria-label' => 'Clear date','x-on:click.prevent.stop' => '$el.closest(\'ui-date-picker\').clear()']); ?>
...
<?php /**PATH /var/www/html/local_packages/flux-pro-main/stubs/resources/views/flux/date-picker/button.blade.php ENDPATH**/ ?>